...
//            DefaultValueAnnotation defaults = f.getAnnotation(DefaultValueAnnotation.class);
...
//    public <T>ArrayList<T>findAllOneToMany(String referenced,String id,Connection con,ObjectBDD join) throws Exception {
////        String Primary = getPrimaryKey();
//        String sql = "select * from "+join.getNomTable()+" where "+referenced+"='"+id+"'";
//        System.out.println(sql);
//        PreparedStatement stat = con.prepareStatement(sql);
//        ResultSet res =  stat.executeQuery();
//        ArrayList<T> list = new ArrayList<>();
//        while (res.next()){
//            T obj = (T) join.getClass().newInstance();
//            System.out.println(join.getClass().getSimpleName()+" "+obj.getClass().getSimpleName());
//            SetResult((ObjectBDD) obj,res,con);
//            list.add(obj);
//        }
//        return list;
//    }
...
//        System.out.println(sql);
    ...
    public void saveAll(Connection con) throws SQLException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        save(con);
        con.close();
    }
    public void save(Connection con) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, SQLException {
        Field[] f = getFieldValid();
